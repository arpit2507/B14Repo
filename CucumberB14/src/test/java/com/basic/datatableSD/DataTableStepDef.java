...
public class DataTableStepDef {
	...
	public void enter_followind_data(DataTable table) throws InterruptedException{
		...
		driver.findElement(By.xpath("//input[@id='u_0_h']")).sendKeys(values4);
		driver.findElement(By.xpath("//input[@id='u_0_j']")).sendKeys(values5);
		driver.findElement(By.xpath("//input[@id='u_0_m']")).sendKeys(values6);
		Thread.sleep(2000);
